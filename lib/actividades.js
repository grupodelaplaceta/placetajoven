...
const CATALOGO = [
  {
    ...
    ejercicios: [
      { id: 'e1', tipo: 'test', puntos: 10, imagen: { dibujo: 'stop' }, enunciado: '¿Qué te obliga a hacer esta señal?', opciones: ['Detenerte por completo y ceder el paso', 'Reducir y seguir si no viene nadie', 'Ceder el paso sin detenerte', 'Prohibido el paso a todo vehículo'], correcta: 0 },
      { id: 'e2', tipo: 'test', puntos: 10, imagen: { dibujo: 'ceda' }, enunciado: '¿Qué significa esta señal?', opciones: ['Ceda el paso', 'Stop', 'Prohibido el paso', 'Calle sin salida'], correcta: 0 },
      { id: 'e3', tipo: 'verdadero_falso', puntos: 10, imagen: { dibujo: 'direccion-obligatoria' }, enunciado: 'Las señales circulares como esta indican, por regla general, una obligación.', correcta: true },
      { id: 'e4', tipo: 'test', puntos: 10, imagen: { dibujo: 'velocidad-minima', texto: '50' }, enunciado: '¿Qué indica esta señal?', opciones: ['Velocidad mínima obligatoria', 'Velocidad máxima permitida', 'Velocidad recomendada', 'Carril reservado a 50 km/h'], correcta: 0 },
      { id: 'e5', tipo: 'test', puntos: 10, imagen: { dibujo: 'velocidad-maxima', texto: '50' }, enunciado: 'Y esta otra señal, ¿qué indica?', opciones: ['Velocidad máxima permitida', 'Velocidad mínima obligatoria', 'Fin de la limitación', 'Velocidad aconsejada'], correcta: 0 },
      { id: 'e6', tipo: 'relacionar', puntos: 10, enunciado: 'Relaciona cada señal con lo que ordena.', pares: [['STOP', 'detenerse y ceder el paso'], ['Ceda el paso', 'prioridad a quien ya circula por la vía'], ['Prohibido el paso', 'no se puede entrar'], ['Dirección obligatoria', 'hay que seguir ese sentido']] },
      { id: 'e7', tipo: 'verdadero_falso', puntos: 10, imagen: { dibujo: 'marca-continua' }, enunciado: 'La línea continua del centro de la calzada no se puede cruzar.', correcta: true },
      { id: 'e8', tipo: 'test', puntos: 10, imagen: { dibujo: 'marca-discontinua' }, enunciado: '¿Qué indica esta marca sobre el asfalto?', opciones: ['Que puede cruzarse con precaución', 'Que nunca puede cruzarse', 'Que solo se puede cruzar de noche', 'Que la vía termina'], correcta: 0 },
      { id: 'e9', tipo: 'test', puntos: 10, imagen: { dibujo: 'peligro' }, enunciado: 'Las señales triangulares como esta sirven para…', opciones: ['Avisar de un peligro', 'Ordenar una obligación', 'Dar información turística', 'Indicar un destino'], correcta: 0 },
      { id: 'e10', tipo: 'test', puntos: 10, imagen: { dibujo: 'orientacion-verde' }, enunciado: '¿Qué tipo de información da esta señal?', opciones: ['Orientación y destino', 'Un peligro próximo', 'Una prohibición', 'Una obligación'], correcta: 0 }
    ]
  },
  {
    id: 'carnet-normas',
    ...
    ejercicios: [
      ...
      { id: 'e7', tipo: 'ordenar', puntos: 10, enunciado: 'Ordena los pasos de un adelantamiento correcto.', elementos: ['Comprobar el espejo y el ángulo muerto', 'Volver a tu carril', 'Señalizar con el intermitente', 'Iniciar el adelantamiento'], correcta: [2, 0, 3, 1] },
      { id: 'e8', tipo: 'relacionar', puntos: 10, enunciado: 'Relaciona cada luz con cuándo se usa.', pares: [['Luz de cruce', 'siempre de noche y en ciudad'], ['Luz de carretera', 'vías interurbanas sin tráfico contrario'], ['Antiniebla delantera', 'niebla densa o lluvia fuerte'], ['Intermitente', 'avisar cualquier maniobra']] },
  ...
  },
  {
    ...
    ejercicios: [
      { id: 'e1', tipo: 'test', puntos: 10, enunciado: 'En un cruce sin señales ni agente, ¿quién tiene prioridad?', opciones: ['El vehículo que se aproxima por la derecha', 'El que llegue más rápido', 'El vehículo más grande', 'El que va recto siempre'], correcta: 0 },
      { id: 'e2', tipo: 'test', puntos: 10, imagen: { dibujo: 'glorieta' }, enunciado: 'Al llegar a una glorieta, tiene prioridad…', opciones: ['Quien ya circula por ella', 'Quien va a entrar', 'El vehículo más rápido', 'El que viene por la izquierda'], correcta: 0 },
      { id: 'e3', tipo: 'test', puntos: 10, enunciado: 'Con carácter general, tienen prioridad de paso…', opciones: ['Los vehículos sobre raíles', 'Los turismos', 'Las bicicletas', 'Los vehículos más pesados'], correcta: 0 },
      { id: 'e4', tipo: 'verdadero_falso', puntos: 10, enunciado: 'En un paso estrecho señalizado a tu favor, tienes preferencia de paso.', correcta: true },
      { id: 'e5', tipo: 'ordenar', puntos: 10, enunciado: 'Ordena cómo se entra y se sale de una glorieta.', elementos: ['Entrar por la derecha', 'Comprobar el tráfico de la glorieta', 'Salir señalizando con antelación', 'Ceder el paso a los que circulan por ella'], correcta: [1, 3, 0, 2] },
      { id: 'e6', tipo: 'relacionar', puntos: 10, enunciado: 'Relaciona cada maniobra con lo que exige.', pares: [['Cambiar de carril', 'señalizar y comprobar el ángulo muerto'], ['Incorporarse a la vía', 'ceder el paso a quien ya circula'], ['Girar a la izquierda', 'situarse junto al eje de la calzada'], ['Marcha atrás', 'solo si es imprescindible y sin desviarse']] },
      { id: 'e7', tipo: 'test', puntos: 10, enunciado: '¿Se puede cambiar el sentido de la marcha en una autopista?', opciones: ['No: hay que salir y volver a entrar', 'Sí, si no viene nadie', 'Sí, usando el arcén', 'Solo de noche'], correcta: 0 },
      { id: 'e8', tipo: 'test', puntos: 10, enunciado: 'Para girar a la derecha debes colocarte…', opciones: ['Lo más cerca posible del borde derecho', 'En el centro de la calzada', 'Junto al eje de la vía', 'En el carril izquierdo'], correcta: 0 },
      { id: 'e9', tipo: 'test', puntos: 10, enunciado: 'Un tranvía y un turismo llegan a la vez a un cruce sin señales. ¿Quién pasa primero?', opciones: ['El tranvía, porque circula sobre raíles', 'El turismo, porque viene por la derecha', 'El que llegue más rápido', 'El turismo, por ser más ágil'], correcta: 0 },
      { id: 'e10', tipo: 'test', puntos: 10, enunciado: 'Vas a girar a la izquierda en una vía de doble sentido. ¿Dónde te colocas?', opciones: ['Junto al eje de la calzada, sin invadir el otro sentido', 'Pegado al bordillo derecho', 'En el centro del carril derecho', 'En el arcén'], correcta: 0 }
    ]
  },
  {
    id: 'carnet-seguridad',
    ...
    ejercicios: [
      ...
      { id: 'e7', tipo: 'relacionar', puntos: 10, enunciado: 'Relaciona cada factor de riesgo con su efecto.', pares: [['Alcohol', 'alarga el tiempo de reacción'], ['Sueño', 'provoca microsueños al volante'], ['Distancia insuficiente', 'alcance al vehículo de delante'], ['Móvil', 'distracción visual y mental']] },
      { id: 'e8', tipo: 'ordenar', puntos: 10, imagen: { dibujo: 'triangulos' }, enunciado: 'Ordena lo que debes hacer al llegar a un accidente.', elementos: ['Colocar los triángulos', 'Detenerse y señalizar', 'No mover al herido salvo peligro inmediato', 'Ponerte el chaleco antes de bajar', 'Llamar al 112'], correcta: [1, 3, 0, 4, 2] },
      { id: 'e9', tipo: 'escrita', puntos: 10, enunciado: 'Número europeo de emergencias.', respuestas: ['112'], solucion: '112' },
      { id: 'e10', tipo: 'test', puntos: 10, enunciado: '¿Qué ayuda de verdad a bajar el alcohol en sangre?', opciones: ['Nada: solo el tiempo', 'Un café muy cargado', 'Una ducha fría', 'Comer mucho'], correcta: 0 }
    ]
  },
  {
    ...
    ejercicios: [
      { id: 'e1', tipo: 'test', puntos: 10, enunciado: '¿Cuándo pasa su primera ITV un turismo particular?', opciones: ['A los 4 años', 'Al año', 'A los 2 años', 'A los 10 años'], correcta: 0 },
      { id: 'e2', tipo: 'test', puntos: 10, enunciado: 'Entre los 4 y los 10 años, la ITV de un turismo particular es…', opciones: ['Cada 2 años', 'Cada año', 'Cada 3 años', 'No hace falta'], correcta: 0 },
      { id: 'e3', tipo: 'test', puntos: 10, enunciado: 'A partir de los 10 años, la ITV de un turismo particular pasa a ser…', opciones: ['Anual', 'Bienal', 'Cada 3 años', 'Cada 5 años'], correcta: 0 },
      { id: 'e4', tipo: 'test', puntos: 10, enunciado: 'Multa mínima por dar positivo en alcohol (sin reincidencia):', opciones: ['500 euros y 4 puntos', '200 euros y 2 puntos', '1.000 euros y 6 puntos', '300 euros y 3 puntos'], correcta: 0 },
      { id: 'e5', tipo: 'test', puntos: 10, enunciado: 'No llevar puesto el cinturón de seguridad supone…', opciones: ['200 euros y 3 puntos', '100 euros sin puntos', '500 euros y 6 puntos', 'Solo un aviso'], correcta: 0 },
      { id: 'e6', tipo: 'verdadero_falso', puntos: 10, enunciado: 'Un conductor novel parte de 8 puntos en el permiso por puntos.', correcta: true },
      { id: 'e7', tipo: 'test', puntos: 10, enunciado: '¿Cuántos puntos tiene un permiso general cuando lo obtienes?', opciones: ['12', '8', '15', '6'], correcta: 0 },
      { id: 'e8', tipo: 'test', puntos: 10, enunciado: '¿Qué ocurre si pierdes todos los puntos?', opciones: ['Pierdes la vigencia del permiso y tienes que volver a obtenerlo', 'Solo pagas una multa', 'Te quedas con 1 punto', 'Nada: se renuevan solos'], correcta: 0 },
      { id: 'e9', tipo: 'verdadero_falso', puntos: 10, enunciado: 'El permiso de la clase B se renueva cada 10 años hasta los 65.', correcta: true },
      { id: 'e10', tipo: 'verdadero_falso', puntos: 10, enunciado: 'El seguro obligatorio cubre los daños causados a terceros.', correcta: true }
    ]
  },
  {
    id: 'carnet-examen',
    ...
    ejercicios: [
      { id: 'e1', tipo: 'test', puntos: 5, imagen: { dibujo: 'ninos' }, enunciado: 'Una señal triangular con este dibujo avisa de…', opciones: ['Proximidad de un lugar frecuentado por niños', 'Zona escolar con prohibición de paso', 'Paso obligatorio para peatones', 'Fin de la zona residencial'], correcta: 0 },
      { id: 'e2', tipo: 'test', puntos: 5, imagen: { dibujo: 'paso-nivel' }, enunciado: 'Ante una señal como esta, debes…', opciones: ['Extremar la precaución y asegurarte de que no viene ningún tren', 'Pasar rápido para no quedarte dentro', 'Detenerte siempre 10 segundos', 'Tocar el claxon antes de cruzar'], correcta: 0 },
      ...
      { id: 'e4', tipo: 'test', puntos: 5, imagen: { dibujo: 'semaforo-ambar' }, enunciado: '¿Qué significa un semáforo como este, en ámbar fijo?', opciones: ['Detenerse, salvo si no se puede hacer con seguridad', 'Acelerar para pasar', 'Prohibido el paso sin excepciones', 'Ceda el paso'], correcta: 0 },
      ...
      { id: 'e13', tipo: 'test', puntos: 5, imagen: { dibujo: 'marca-amarilla' }, enunciado: '¿Qué indica una marca amarilla como esta junto al bordillo?', opciones: ['Que el estacionamiento está restringido', 'Que se puede aparcar sin límite', 'Que la vía es de sentido único', 'Que hay un carril bici'], correcta: 0 },
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { id: 'e4', tipo: 'sql', puntos: 20, enunciado: 'Escribe una consulta que devuelva todos los usuarios.', esperado: 'select * from usuarios', alternativas: ['select * from usuarios;', 'select * from usuarios '], solucion: 'SELECT * FROM usuarios;', pista: 'Hay que devolver todas las columnas sin enumerarlas una a una.' },
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { id: 'e2', tipo: 'excel', puntos: 40, enunciado: 'En C2, calcula el importe (precio × cantidad).', esperado: '=b2*c2', alternativas: ['=c2*b2', 'b2*c2'], solucion: '=B2*C2', pista: 'Toda fórmula empieza por = y trabaja con la referencia de cada celda.' },
...
function catalogoPublico() {
  ...
  return CATALOGO.map((actividad) => ({
    ...
    ejercicios: actividad.ejercicios.map((e) => ({
      ...
      derecha: e.pares ? e.pares.map(([, der]) => der) : null,      // figura: solo el nombre del dibujo; el trazado y la fuente los pone la interfaz
      imagen: e.imagen ? { ...e.imagen } : null,      pista: e.pista || null
    }))
  }));
}
...
/* Las figuras se dibujan en el cliente (public/js/senales.js). Aquí solo se
   guarda el nombre del dibujo, y este es el listado de los que existen: si
   alguien escribe uno que no está, la prueba automática lo detecta. */
const FIGURAS = [
  'stop', 'ceda', 'prohibido-paso', 'velocidad-maxima', 'velocidad-minima',
  'direccion-obligatoria', 'giro-obligatorio', 'prohibido-estacionar',
  'peligro', 'ninos', 'paso-nivel', 'pavimento', 'cruce',
  'orientacion-verde', 'semaforo-ambar', 'glorieta', 'triangulos',
  'marca-continua', 'marca-discontinua', 'marca-amarilla', 'paso-cebra', 'flecha-carril'
];
...
module.exports = { TIPOS, CATALOGO, FIGURAS, catalogoPublico, actividad, corregirEjercicio, comprobarEjercicio, normalizar, parecida, puntuar, revision, estado, enviarIntento };
