...
const CATALOGO = [
  {
    ...
    ejercicios: [
      { id: 'e1', tipo: 'test', puntos: 10, imagen: { dibujo: 'stop' }, enunciado: '¿Qué te obliga a hacer esta señal?', opciones: ['Detenerte por completo y ceder el paso', 'Reducir y seguir si no viene nadie', 'Ceder el paso sin detenerte', 'Prohibido el paso a todo vehículo'], correcta: 0, pista: 'Su forma, distinta a todas las demás, ya avisa de que no es una recomendación.' },
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { id: 'e2', tipo: 'test', puntos: 12, imagen: { dibujo: 'glorieta' }, enunciado: 'Al llegar a una glorieta, tiene prioridad…', opciones: ['Quien ya circula por ella', 'Quien va a entrar', 'El vehículo más rápido', 'El que viene por la izquierda'], correcta: 0 },
  ...
  },
  {
    ...
    ejercicios: [
      ...
      { id: 'e8', tipo: 'ordenar', puntos: 15, imagen: { dibujo: 'triangulos' }, enunciado: 'Ordena lo que debes hacer al llegar a un accidente.', elementos: ['Colocar los triángulos', 'Detenerse y señalizar', 'No mover al herido salvo peligro inmediato', 'Ponerte el chaleco antes de bajar', 'Llamar al 112'], correcta: [1, 3, 0, 4, 2] },
